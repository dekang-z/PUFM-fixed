...
> **Note:** This repository fixes all critical runtime bugs in the original release and has been verified to run out-of-the-box on **Python 3.9 + PyTorch 1.13 + CUDA 11.6**. See Known Fixes for a complete list of patched issues.
